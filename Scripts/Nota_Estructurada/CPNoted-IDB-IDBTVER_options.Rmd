...
IDBTVER <- c("ABB",
             ...
             "CRRFY", "CENCOSHOPP.SN","CHYHY", 
             "SGO.VI", "CIG", "ELP", , "BSN.F", "ETN", "ENIA", "EGIEY",
             "FUNO11.MX","FLEX", "FS", "G", "GF", "GIVN", "GBOOY", "HPE", "HOTG", "HPQ", 
...
IDBTVER_Portfolio <- merge.xts(get(IDBTVER_ad[1]),
                       get(IDBTVER_ad[2]),
                       join = "inner")
...
IDBTVER_Returns <- Return.calculate(IDBTVER_Portfolio,
                                    method="log")[-1,]
```
